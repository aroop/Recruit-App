namespace :db do
  ...
  task :bootstrap => :environment do
    ...
    if SubscriptionPlan.count == 0
      plans = [
        { 'name' => 'Free', 'amount' => 0, 'user_limit' => 2, 'storage' => nil },
        { 'name' => 'Basic', 'amount' => 24, 'user_limit' => 6, 'storage' => 3 },
        { 'name' => 'Plus', 'amount' => 49, 'user_limit' => 15, 'storage' => 10 },
        { 'name' => 'Premium', 'amount' => 99, 'user_limit' => 40, 'storage' => 20 },
        { 'name' => 'Max', 'amount' => 149, 'user_limit' => nil, 'storage' => 50 }
      ].collect do |plan|
